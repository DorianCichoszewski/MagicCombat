    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            v2f vert(appdata_t v )
            {
                ...
                v.vertex.xyz += float3( ( -appendResult314 + ( ( ( appendResult346 * float2( 2,0 ) ) + float2( -1,0 ) ) * _EmitterDimensions ) + ( appendResult312 * Lifetime_Size192 ) + Travel_Distance291 + Random_Position_Offset377 ) ,  0.0 );
...
Node;AmplifyShaderEditor.CommentaryNode;381;-3042,2238;Inherit;False;2813.495;1173.844;;3;380;311;376;Movement;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;82;192,512;Inherit;False;5;5;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=85FBF6019A238227005CE511049B0F7DE906A8FD