...
Shader "UI Particles"
{
    Properties
    {
        _Color ("Tint", Color) = (1,1,1,1)
         ...
         _fMovement("[f] Movement", Float) = 0
         _Speed("Speed", Vector) = (0,0,0,0)
         _Acceleration("Acceleration", Vector) = (0,0,0,0)
         _HNoise("[H] Noise", Float) = 0
         _MaxNoiseMovment("Max Noise Movment", Vector) = (0,0,0,0)
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            uniform float _fMovement;
            uniform float _HNoise;
            ...
            v2f vert(appdata_t v )
            {
                ...
                float3 temp_cast_0 = (( floor( ( Quad_Value153 * 1000000.0 ) ) + temp_output_158_0 )).xxx;
                float3 p3_g1 = temp_cast_0;
                float3 localHashVector33_g1 = HashVector33_g1( p3_g1 );
                float3 Hash_3_Quad97 = localHashVector33_g1;
                float2 appendResult346 = (float2(Hash_3_Quad97.xy));
                ...
                float Noise_for_Position364 = lerpResult10_g28;
                float2 appendResult367 = (float2(Noise_for_Position364 , Lifetime_seconds195));
                float simpleNoise349 = SimpleNoise( appendResult367*_NoiseScale );
                float2 appendResult371 = (float2(( 45.5 + Noise_for_Position364 ) , Lifetime_seconds195));
                ...
                v.vertex.xyz = ( Correct_Object_Position152 + float3( ( ( ( appendResult346 * float2( 2,0 ) ) + float2( -1,0 ) ) * _EmitterDimensions ) ,  0.0 ) + float3( ( appendResult312 * Lifetime_Size192 ) ,  0.0 ) + float3( Travel_Distance291 ,  0.0 ) + float3( Random_Position_Offset377 ,  0.0 ) );
...
Node;AmplifyShaderEditor.CommentaryNode;376;-2016,2416;Inherit;False;1630.981;538.4268;;16;385;374;377;387;375;367;383;349;370;373;372;371;369;382;365;368;Movement Noise;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;364;-3824,352;Inherit;False;Noise for Position;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;369;-1952,2784;Inherit;False;364;Noise for Position;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;365;-1952,2544;Inherit;False;364;Noise for Position;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;383;-1664,2688;Inherit;False;Property;_NoiseScale;Noise Scale;30;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;329;-800,512;Inherit;False;97;Hash 3 Quad;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;346;-576,512;Inherit;False;FLOAT2;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector2Node;385;-1056,2512;Inherit;False;Property;_MaxNoiseMovment;Max Noise Movment;29;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-432,512;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;2,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;190;-640,736;Inherit;False;189;Vertex Offset From Center;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;45;-288,512;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;-1,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;217;-448,816;Inherit;False;192;Lifetime Size;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;312;-352,736;Inherit;False;FLOAT2;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;-176,752;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;293;-192,848;Inherit;False;291;Travel Distance;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;378;-176,912;Inherit;False;377;Random Position Offset;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;286;-96,80;Inherit;False;280;Lifetime Color;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;389;-272,432;Inherit;False;152;Correct Object Position;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;82;192,512;Inherit;False;5;5;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;218;-4144,80;Inherit;False;Property;_fUnrealated;[f] Unrealated;31;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-2976,2288;Inherit;False;Property;_fMovement;[f] Movement;25;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;382;-1952,2464;Inherit;False;Property;_HNoise;[H] Noise;28;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0F2D2771E61D9BD49930A27D76EF92514FAC9124