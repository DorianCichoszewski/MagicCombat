...
Shader "UI Particles"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            float3 HashVector33_g16( float3 p )
            {
            ...
            v2f vert(appdata_t v )
            {
                ...
                float temp_output_158_0 = ( ( _ParticleLifetime * _Time.y ) + Quad_Value153 );
                float3 temp_cast_0 = (( ( Quad_Value153 * 16250.0 ) + temp_output_158_0 )).xxx;
                float3 p3_g16 = temp_cast_0;
                float3 localHashVector33_g16 = HashVector33_g16( p3_g16 );
                float3 Hash_3_Quad97 = localHashVector33_g16;
                ...
                float dotResult4_g13 = dot( Hash_3_Quad97.xy , float2( 12.9898,78.233 ) );
                float lerpResult10_g13 = lerp( _MinStartSize , _MaxStartSize , frac( ( sin( dotResult4_g13 ) * 43758.55 ) ));
                float lerpResult122 = lerp( _EndSize , _StartSize , frac( temp_output_158_0 ));
                

                v.vertex.xyz += ( float3( ( ( ( appendResult43 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _EmitterDimensions ) ,  0.0 ) + ( ( ( v.vertex.xyz - Correct_Object_Position152 ) * ( lerpResult10_g13 + -1.0 ) ) * lerpResult122 ) );
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float temp_output_4_0_g14 = _FlipbookCells.x;
                float temp_output_5_0_g14 = _FlipbookCells.y;
                // *** BEGIN Flipbook UV Animation vars ***
                // Total tiles of Flipbook Texture
                float fbtotaltiles246_g14 = min( temp_output_4_0_g14 * temp_output_5_0_g14, ( ( temp_output_4_0_g14 * temp_output_5_0_g14 ) - 0.0 ) + 1 );
                // Offsets for cols and rows of Flipbook Texture
                float fbcolsoffset246_g14 = 1.0f / temp_output_4_0_g14;
                float fbrowsoffset246_g14 = 1.0f / temp_output_5_0_g14;
                // Speed of animation
                float fbspeed246_g14 = _Time.y * ( ( _FlipbookCells.x * _FlipbookCells.y ) * _ParticleLifetime );
                // UV Tiling (col and row offset)
                float2 fbtiling246_g14 = float2(fbcolsoffset246_g14, fbrowsoffset246_g14);
                // UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
                // Calculate current tile linear index
                float fbcurrenttileindex246_g14 = floor( fmod( fbspeed246_g14 + _Float0, fbtotaltiles246_g14) );
                fbcurrenttileindex246_g14 += ( fbcurrenttileindex246_g14 < 0) ? fbtotaltiles246_g14 : 0;
                // Obtain Offset X coordinate from current tile linear index
                float fblinearindextox246_g14 = round ( fmod ( fbcurrenttileindex246_g14, temp_output_4_0_g14 ) );
                // Multiply Offset X by coloffset
                float fboffsetx246_g14 = fblinearindextox246_g14 * fbcolsoffset246_g14;
                // Obtain Offset Y coordinate from current tile linear index
                float fblinearindextoy246_g14 = round( fmod( ( fbcurrenttileindex246_g14 - fblinearindextox246_g14 ) / temp_output_4_0_g14, temp_output_5_0_g14 ) );
                // Reverse Y to get tiles from Top to Bottom
                fblinearindextoy246_g14 = (int)(temp_output_5_0_g14-1) - fblinearindextoy246_g14;
                // Multiply Offset Y by rowoffset
                float fboffsety246_g14 = fblinearindextoy246_g14 * fbrowsoffset246_g14;
                // UV Offset
                float2 fboffset246_g14 = float2(fboffsetx246_g14, fboffsety246_g14);
                // Flipbook UV
                half2 fbuv246_g14 = IN.texcoord.xy * fbtiling246_g14 + fboffset246_g14;
                // *** END Flipbook UV Animation vars ***
                int flipbookFrame246_g14 = ( ( int )fbcurrenttileindex246_g14);
                

                half4 color = ( IN.color * tex2D( _MainTex, fbuv246_g14 ) );
...
Node;AmplifyShaderEditor.CommentaryNode;119;-1584,416;Inherit;False;740;314.8;Particle Lifetime;5;117;115;113;121;158;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;112;-1584,128;Inherit;False;862;249.75;Particle Random Values;5;97;120;135;141;154;;0,0,0,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;153;-2176,272;Inherit;False;Quad Value;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;154;-1568,176;Inherit;False;153;Quad Value;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;158;-1120,480;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;141;-1344,192;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;16250;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;120;-1200,192;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;135;-1088,192;Inherit;False;HashVector3;-1;;16;e08360d15330cbd429407eddabb4c325;0;1;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;90;-1296,960;Inherit;False;Random Range;-1;;13;7b754edb8aebbfb4a9ace907af661cfc;0;3;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=B6C19D793E467B2F60DB64B9A933B1AAA95CFDED